...
import nuxt_plugin_themeclient_53b4db67 from 'nuxt_plugin_themeclient_53b4db67' // Source: ../plugins/theme.client.ts (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (process.client && typeof nuxt_plugin_themeclient_53b4db67 === 'function') {
    await nuxt_plugin_themeclient_53b4db67(app.context, inject)
  }
